...
RUN apt-get update && \
    ...
    apt-get install --yes --quiet php7.2-bcmath php7.2-ctype php7.2-curl php7.2-dom php7.2-gd php7.2-iconv php7.2-json php7.2-intl  php7.2-mbstring   php7.2-mysql  php7.2-simplexml php7.2-soap php7.2-xsl php7.2-zip && \
